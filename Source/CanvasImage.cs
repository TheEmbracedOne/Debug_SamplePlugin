...
namespace SamplePlugin
{
    public class CanvasImage
    {
        ...
        public CanvasImage(GameObject parent, Texture2D tex, Vector2 pos, Vector2 size, Rect subSprite)
        {
            ...
            Object.DontDestroyOnLoad(_imageObj.transform.root);
        ...
        {
            if (_imageObj == null) return;
            var position = new Vector2((pos.x + ((_sz.x / _sub.width) * _sub.width) / 2f) / 1920f, (1080f - (pos.y + ((_sz.y / _sub.height) * _sub.height) / 2f)) / 1080f);
